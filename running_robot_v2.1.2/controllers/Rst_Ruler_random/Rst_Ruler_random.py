...
class runningrobot_env:
    ...
    def set_sub_ball(self, pos, rot):
        ...
        pos_ball = [pos[0],BALL_HEIGHT, pos[2]]
        if isBallInCorner == 1:
            pos[2] = pos[2] - 0.4
            pos_ball[2] = pos[2] + 0.4
            
        self.ball.resetPhysics
        ball_pos.setSFVec3f(pos_ball)
    ...
    def Random_setLevel(self):
        ...
        if block_type1[1] == block[5] or (block_type1[1] == block[4] and block_direc[4]==-1) or (block_type1[1] == block[3] and block_direc[3]==-1):
            global isBallInCorner
            isBallInCorner = 1
